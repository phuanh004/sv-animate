<script lang="ts">
	...
	// Circles
	let div1Ref: SVGElement | null = $state(null);
	let div2Ref: SVGElement | null = $state(null);
	let div3Ref: SVGElement | null = $state(null);
	let div4Ref: SVGElement | null = $state(null);
	let div5Ref: SVGElement | null = $state(null);
	let div6Ref: SVGElement | null = $state(null);
	let div7Ref: SVGElement | null = $state(null);
	// let className: any = $state('');
	// export { className as class };
  let { class: className = '' }: { class?: any } = $props();
</script>
