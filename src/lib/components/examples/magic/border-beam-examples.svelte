...
<article
	class="bg-background relative flex max-w-xl flex-col items-start justify-between rounded-3xl border border-gray-700/70 p-7"
>
	<BorderBeam size={190} duration={8} />
	...
	<div class="group relative">
		<h3 class="mt-3 text-lg leading-6 font-semibold text-gray-200 group-hover:text-gray-50">
			<a href="/">
